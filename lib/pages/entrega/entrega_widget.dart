...
class _EntregaWidgetState extends State<EntregaWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EntregaModel());
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Padding(
                                    padding: const EdgeInsetsDirectional.fromSTEB(
                                        12.0, 0.0, 12.0, 0.0),
                                    child: StreamBuilder<List<EnderecoRecord>>(
                                      ...
                                      builder: (context, snapshot) {
                                        ...
                                        List<EnderecoRecord>
                                            enderecosOptionEnderecoRecordList =
                                            snapshot.data!;
                                        // Return an empty Container when the item does not exist.
                                        if (snapshot.data!.isEmpty) {
                                          return Container();
                                        }
                                        final enderecosOptionEnderecoRecord =
                                            enderecosOptionEnderecoRecordList
                                                    .isNotEmpty
                                                ? enderecosOptionEnderecoRecordList
                                                    .first
                                                ...
                                                children: [
                                                  ...
                                                  Padding(
                                                    ...
                                                    child: Row(
                                                      ...
                                                      children: [
                                                        Text(
                                                          '${enderecosOptionEnderecoRecord.rua}, ${enderecosOptionEnderecoRecord.bairro}, ${enderecosOptionEnderecoRecord.numero}',
                                                          style: FlutterFlowTheme
                                                                  .of(context)
                                                              .bodyMedium
                                                              .override(
                                                  ...
                                                  Row(
                                                    ...
                                                    children: [
                                                      Text(
                                                        '${enderecosOptionEnderecoRecord.cidade} - ${enderecosOptionEnderecoRecord.estado}',
                                                        style: FlutterFlowTheme
                                                                .of(context)
                                                            .bodyMedium
                                                            .override(
