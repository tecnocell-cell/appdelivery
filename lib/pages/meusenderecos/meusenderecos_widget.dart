...
import 'meusenderecos_model.dart';
export 'meusenderecos_model.dart';
    ...
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Padding(
            padding: const EdgeInsetsDirectional.fromSTEB(12.0, 12.0, 300.0, 0.0),
            child: InkWell(
                            ...
                            builder: (context) => Builder(
                              builder: (context) {
                                final enderecosUsuario =
                                    (currentUserDocument?.endereco.toList() ??
                                            [])
                                        .toList();
                                return Column(
                                  mainAxisSize: MainAxisSize.max,
