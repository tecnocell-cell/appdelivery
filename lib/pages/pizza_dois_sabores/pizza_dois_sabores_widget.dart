...
import 'pizza_dois_sabores_model.dart';
export 'pizza_dois_sabores_model.dart';

class PizzaDoisSaboresWidget extends StatefulWidget {
  const PizzaDoisSaboresWidget({
    super.key,
    this.pizzaindex,
  });
  ...
  @override
  _PizzaDoisSaboresWidgetState createState() => _PizzaDoisSaboresWidgetState();
}

class _PizzaDoisSaboresWidgetState extends State<PizzaDoisSaboresWidget>
    with TickerProviderStateMixin {
  late PizzaDoisSaboresModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PizzaDoisSaboresModel());
