                              ...
                              children: [
                                Padding(
                                  ...
                                  child: FlutterFlowChoiceChips(
                                    options: const [
                                      ChipData('Todas', Icons.local_pizza),
                                      ChipData(
                                          'Massas', Icons.local_pizza_sharp),
                                      ChipData(
              ...
              Padding(
                ...
                child: StreamBuilder<List<ProdutosRecord>>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    List<ProdutosRecord> columnProdutosRecordList =
                        snapshot.data!;
                    return SingleChildScrollView(
                      child: Column(
                        mainAxisSize: MainAxisSize.min,
                        children: List.generate(columnProdutosRecordList.length,
                            (columnIndex) {
                          final columnProdutosRecord =
                              columnProdutosRecordList[columnIndex];
                          return Padding(
                            padding: const EdgeInsetsDirectional.fromSTEB(
                                0.0, 5.0, 0.0, 5.0),
                            child: Container(
