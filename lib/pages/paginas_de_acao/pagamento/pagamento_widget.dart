...
class _PagamentoWidgetState extends State<PagamentoWidget>
  ...
  void initState() {
    ...
    _model.cardController ??= TextEditingController();
    _model.cardFocusNode ??= FocusNode();

    _model.expDataController ??= TextEditingController();
    _model.expDataFocusNode ??= FocusNode();

    _model.codSegController ??= TextEditingController();
    _model.codSegFocusNode ??= FocusNode();
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              Text(
                                'Digite Seus Dados de Pagamento Abaixo.',
                                style: FlutterFlowTheme.of(context)
                                    .bodyMedium
                                    .override(
                                      fontFamily: 'Roboto',
                                        ...
                                        child: Padding(
                                          padding:
                                              const EdgeInsetsDirectional.fromSTEB(
                                                  8.0, 0.0, 8.0, 0.0),
                                          child: TextFormField(
                                            controller: _model.cardController,
                                            focusNode: _model.cardFocusNode,
                                            autofillHints: const [
                                            ...
                                            validator: _model
                                                .cardControllerValidator
                                                .asValidator(context),
                                            inputFormatters: [_model.cardMask],
                                          ),
                                        ),
                                      ),
                                    ),
                                        ...
                                        children: [
                                          ...
                                          Form(
                                            ...
                                            child: Padding(
                                              ...
                                              child: TextFormField(
                                                controller:
                                                    _model.expDataController,
                                                focusNode:
                                                    _model.expDataFocusNode,
                                                autofillHints: const [
                                                  AutofillHints
                                        ...
                                        children: [
                                          ...
                                          Form(
                                            ...
                                            child: Padding(
                                              ...
                                              child: TextFormField(
                                                controller:
                                                    _model.codSegController,
                                                focusNode:
                                                    _model.codSegFocusNode,
                                                autofillHints: const [
                                                  AutofillHints
