...
import 'seleciona_endereco_model.dart';
export 'seleciona_endereco_model.dart';

class SelecionaEnderecoWidget extends StatefulWidget {
  const SelecionaEnderecoWidget({super.key});

  @override
  _SelecionaEnderecoWidgetState createState() =>
      _SelecionaEnderecoWidgetState();
}

class _SelecionaEnderecoWidgetState extends State<SelecionaEnderecoWidget> {
  late SelecionaEnderecoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SelecionaEnderecoModel());
