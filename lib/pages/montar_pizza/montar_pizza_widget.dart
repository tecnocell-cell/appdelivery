  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<ProdutosRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<ProdutosRecord> montarPizzaProdutosRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final montarPizzaProdutosRecord =
            montarPizzaProdutosRecordList.isNotEmpty
                ? montarPizzaProdutosRecordList.first
                : null;
          ...
          child: Scaffold(
            ...
            body: Column(
              ...
              children: [
                Padding(
                  padding:
                      const EdgeInsetsDirectional.fromSTEB(60.0, 50.0, 60.0, 0.0),
                  child: Row(
                    mainAxisSize: MainAxisSize.max,
