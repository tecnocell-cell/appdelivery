...
class EditarEnderecoWidget extends StatefulWidget {
  const EditarEnderecoWidget({
    super.key,
    required this.paramEditaEndereco,
  });

  final DocumentReference? paramEditaEndereco;
...
class _EditarEnderecoWidgetState extends State<EditarEnderecoWidget>
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<EnderecoRecord>(
      stream: EnderecoRecord.getDocument(widget.paramEditaEndereco!),
                                  ...
                                  child: Padding(
                                    ...
                                    child: TextFormField(
                                      controller: _model.textRuaController ??=
                                          TextEditingController(
                                        text: editarEnderecoEnderecoRecord.rua,
                                      ),
                                    ...
                                    child: TextFormField(
                                      controller:
                                          _model.textBairroController ??=
                                              TextEditingController(
                                        text:
                                            editarEnderecoEnderecoRecord.bairro,
                                      ),
                                    ...
                                    child: TextFormField(
                                      controller:
                                          _model.textCidadeController ??=
                                              TextEditingController(
                                        text:
                                            editarEnderecoEnderecoRecord.cidade,
                                      ),
                                ...
                                Container(
                                  ...
                                  child: Padding(
                                    ...
                                    child: TextFormField(
                                      ...
                                      obscureText: false,
                                      decoration: InputDecoration(
                                        labelText: editarEnderecoEnderecoRecord
                                            .identificador,
                                        labelStyle: FlutterFlowTheme.of(context)
                                            .labelMedium
                                            .override(
