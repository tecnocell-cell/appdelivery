...
import 'seleciona_end_entrega_model.dart';
export 'seleciona_end_entrega_model.dart';

class SelecionaEndEntregaWidget extends StatefulWidget {
  const SelecionaEndEntregaWidget({super.key});

  @override
  _SelecionaEndEntregaWidgetState createState() =>
      _SelecionaEndEntregaWidgetState();
}

class _SelecionaEndEntregaWidgetState extends State<SelecionaEndEntregaWidget> {
  late SelecionaEndEntregaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SelecionaEndEntregaModel());
