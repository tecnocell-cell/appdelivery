...
class RestauranteINFOSStruct extends FFFirebaseStruct {
  ...
  // "cocumento" field.
  String? _cocumento;
  String get cocumento => _cocumento ?? '';
  set cocumento(String? val) => _cocumento = val;
  bool hasCocumento() => _cocumento != null;
  ...
  static RestauranteINFOSStruct fromMap(Map<String, dynamic> data) =>
      RestauranteINFOSStruct(
        ...
        cocumento: data['cocumento'] as String?,
