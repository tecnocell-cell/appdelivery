...
class VendaRecord extends FirestoreRecord {
  ...
  // "valoTotal" field.
  double? _valoTotal;
  double get valoTotal => _valoTotal ?? 0.0;
  bool hasValoTotal() => _valoTotal != null;
  ...
  void _initializeFields() {
    _valoTotal = castToType<double>(snapshotData['valoTotal']);
...
class VendaRecordDocumentEquality implements Equality<VendaRecord> {
  ...
  bool equals(VendaRecord? e1, VendaRecord? e2) {
    ...
    return e1?.valoTotal == e2?.valoTotal &&
